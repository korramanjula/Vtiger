...
public class CreateOragnisationWithPhoneNum {
	@Test
	public void CreateOrganisation() {
		...
		//verify actual phn and expected phn
		WebElement phntf=driver.findElement(By.id("mouseArea_Phone"));
		if(phntf.getText().contains(phn)) {
			System.out.println(phn+"test pass");
		
		}else {
			System.out.println("phn is not created");
